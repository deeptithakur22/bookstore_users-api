...
import (
	...
	"github.com/deeptithakur22/bookstore_oauth-go/oauth/errors"
...
func getAccessToken(accessTokenId string) (*accessToken, *errors.RestErr) {
	...
	if err := json.Unmarshal(response.Bytes(), &at); err != nil {
		return nil, errors.NewInternalServerError("error when trying to unmarshel access token response")
	}
	return &at, nil
}
